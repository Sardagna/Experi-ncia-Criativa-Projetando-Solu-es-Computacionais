...
<div class="w3-panel w3-padding-large w3-card-4 w3-light-grey">
  ...
  <!-- Acesso em:-->
	...
	<?php
		...
		$sql = "INSERT INTO funcionario_especialidade (especialidade_id, funcionario_id, nivel) VALUES ('$especialidade_id','$funcionario_id','$nivel')";
		echo "<div class='w3-responsive w3-card-4'>";
		if ($result = mysqli_query($conn, $sql)) {
			echo "Especialidade Registrada!";
		} else {
