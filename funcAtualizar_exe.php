<!DOCTYPE html>
	...
	<head>
	  ...
	  <style>
		.w3-theme {color:#ffff !important;background-color:green !important}
		.w3-code{border-left:4px solid green}
	...
	<div class="w3-panel w3-padding-large w3-card-4 w3-light-grey">
	  ...
	  <!-- Acesso em:-->
		...
		<?php
			...
			$sql = "UPDATE Funcionario SET Nome = '$nome', Celular = '$celular', DataNasc = '$dtNasc', Login = '$login' , Senha = '$md5Senha' WHERE CodFuncionario = $id";
