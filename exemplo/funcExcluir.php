            ...
            <div class="w3-code cssHigh notranslate">
				...
				?>
								<div class="w3-container w3-theme">
									<h2>Exclusão do Funcionario Cód. = [<?php echo $row['CodFuncionario']; ?>]</h2>
								</div>
								<form class="w3-container" action="funcExcluir_exe.php" method="post" onsubmit="return check(this.form)">
