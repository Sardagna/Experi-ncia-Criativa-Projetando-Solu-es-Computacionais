...
<div class="w3-main w3-container" style="margin-left:270px;margin-top:117px;">
    ...
    <div class="w3-panel w3-padding-large w3-card-4 w3-light-grey">
        <h1 class="w3-xxlarge">Atualização Cadastral de Funcionario</h1>
        ...
        <p class="w3-large">
            <div class="w3-code cssHigh notranslate">
				...
				$sql = "SELECT CodFuncionario, Nome, Celular, DataNasc, Login FROM Funcionario WHERE codFuncionario = $id";
				...
				?>
								<div class="w3-container w3-theme">
									<h2>Altere os dados do Funcionario Cód. = [<?php echo $row['CodFuncionario']; ?>]</h2>
								</div>
								<form class="w3-container" action="funcAtualizar_exe.php" method="post" onsubmit="return check(this.form)">
									<input type="hidden" id="Id" name="Id" value="<?php echo $row['CodFuncionario']; ?>">
									<p>
									...
									<input type="button" value="Cancelar" class="w3-btn w3-theme" onclick="window.location.href='funcListar.php'"></p>
								</form>
			<?php 
							}
						}
