    ...
    <div class="w3-panel w3-padding-large w3-card-4 w3-light-grey">
        ...
        <p class="w3-large">
            <div class="w3-code cssHigh notranslate">
				...
				$sql = "SELECT t.codTurma, p.nome, d.nomehabi, t.ano, t.semestre FROM Turma as t, habilidade as d, Funcionario as P WHERE t.codhabi = d.codhabilidade AND t.codFuncionario = p.codFuncionario AND codTurma = $id";
				...
				?>
								...
								<form class="w3-container" action="turmaExcluir_exe.php" method="post" onsubmit="return check(this.form)">
									...
									<p>
									<label class="w3-text-deep-purple"><b>Funcionario: </b> <?php echo $row['nome']; ?> </label></p>
									<p>
									<label class="w3-text-deep-purple"><b>habilidade: </b><?php echo $row['nomehabi']; ?></label></p>
									<p>
									...
									<input type="button" value="Cancelar" class="w3-btn w3-theme" onclick="window.location.href='habiListar.php'"></p>
								</form>
			<?php 
							}
						}
